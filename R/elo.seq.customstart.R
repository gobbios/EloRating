...
#'
#' calculate Elo ratings from a sequence of dominance interactions with custom starting values and optional varying k-values
#'
...
#' SEQ <- elo.seq.customstart(winner=adv2$winner, loser=adv2$loser, Date=adv2$Date,
...
elo.seq.customstart <- function(winner, loser, Date, draw = NULL, presence = NULL, startvalue = 1000, k = 100, normprob = TRUE, init = "average", intensity = NULL, iterate = 0, runcheck = TRUE, progressbar = FALSE) {
